  ...
  return (
    <main className="p-4 sm:p-6 md:p-8 bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="w-full text-center text-white text-lg">Loading...</div>
        ) : filteredPokemon?.length > 0 ? (
          <>
            <div className='w-full text-sm text-center mb-8 text-gray-300'>Pokémon from the OG 151:</div>
          ...
          <div className="w-full text-center text-white text-lg">No Pokémon Found.</div>
        )}
      </div>
    </main>
  );
